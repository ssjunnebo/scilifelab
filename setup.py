...
scripts=glob.glob('scripts/*.py') + glob.glob('scripts/*.sh') + glob.glob('scripts/analysisDB/*.py') +glob.glob('scripts/RNA_analysis/*.py') + glob.glob('scripts/bcbb_helpers/*.py') + glob.glob('scilifelab/lims_utils/*.py') + ['scripts/pm', 'scripts/stdin_to_redis', 'scripts/adler32']
try:
